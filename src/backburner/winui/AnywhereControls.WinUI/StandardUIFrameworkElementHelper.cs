    ...
    internal struct StandardUIFrameworkElementHelper
    {
        ...
        public void OnRender(IVisual visual, double width, double height, DrawingContext drawingContext)
        {
            ...
            else
            {
                ...
                _bitmap.Unlock();
                drawingContext.DrawImage(_bitmap, new Windows.Foundation.Rect(0, 0, widthInPixels, heightInPixels));

                //var rect = new Windows.Foundation.Rect(0, 0, 175, 50);
                //drawingContext.DrawRectangle(new SolidColorBrush(global::Windows.UI.Colors.Red), null, rect);
            }
