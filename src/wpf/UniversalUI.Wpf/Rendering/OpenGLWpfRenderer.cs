...
internal partial class OpenGLWpfRenderer : IWpfRenderer
{
	...
	public OpenGLWpfRenderer(IWpfUIRootHost host)
	{
...
#pragma warning restore CA1806 // Do not ignore method results
		...
		if (_backBuffer != null)
		{
			...
			drawingContext.DrawImage(_backBuffer, new System.Windows.Rect(0, 0, _hostControl.ActualWidth, _hostControl.ActualHeight));
		}
	}
