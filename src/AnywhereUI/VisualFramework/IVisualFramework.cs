...
namespace AnywhereUI.VisualFramework;
...
public interface IVisualFramework
{
    ...
    public abstract IUIElement CreateRendererUIElement(IUIElement rootElement,
    ...
    public Renderer CreateRenderer(IUIElement rootElement,
        object? arg1 = null, object? arg2 = null, object? arg3 = null);

    public Size MeasureTextBlock(ITextBlock textBlock);

    public ITextShaper CreateTextShaper(ITypeface typeface);
}
