// This code was adapted from the WPF source here: https://github.com/dotnet/wpf/blob/e6a8177202c8c584c4b8d532dd8bc95388d3a07b/src/Microsoft.DotNet.Wpf/src/Shared/MS/Utility/FrugalMap.cs
...
abstract class FrugalMapBase
{
    ...
    public ArgumentException CreateTargetMapCannotHoldAllDataException(FrugalMapBase newMap) =>
        new ArgumentException(string.Format("Cannot promote from '{0}' to '{1}' because the target map is too small.", this.ToString(), newMap.ToString()), "newMap");
...
internal sealed class SingleObjectMap : FrugalMapBase
{
    ...
    public SingleObjectMap()
    {
        ...
        _loneEntry.Value = UnsetValue.Instance;
    }
    ...
    public override void Promote(FrugalMapBase newMap)
    {
        ...
        else
        {
            ...
            throw new ArgumentException(string.Format("Cannot promote from '{0}' to '{1}' because the target map is too small.", this.ToString(), newMap.ToString()), "newMap");
        }
    }
...
internal sealed class ThreeObjectMap : FrugalMapBase
{
        ...
        switch (_count)
        {
            case 1:
                if (_entry0.Key == key)
                {
                    ...
                    _entry0.Value = UnsetValue.Instance;
                    --_count;
                    return;
                }
                break;
            ...
            case 2:
                if (_entry0.Key == key)
                {
                    ...
                    _entry1.Value = UnsetValue.Instance;
                    --_count;
                    break;
                }
                if (_entry1.Key == key)
            ...
            case 3:
                if (_entry0.Key == key)
                {
                    ...
                    _entry2.Value = UnsetValue.Instance;
                    --_count;
                    break;
                }
                if (_entry1.Key == key)
    ...
    public override void Promote(FrugalMapBase newMap)
    {
        ...
        {
            // newMap is smaller than previous map
            throw CreateTargetMapCannotHoldAllDataException(newMap);
        }
        ...
        switch (_count)
        {
            ...
            case 4:
                if (_entry0.Key == key)
                {
                    ...
                    _entry3.Value = UnsetValue.Instance;
                    --_count;
                    break;
                }
                if (_entry1.Key == key)
            ...
            case 5:
                if (_entry0.Key == key)
                {
                    ...
                    _entry4.Value = UnsetValue.Instance;
                    --_count;
                    break;
                }
                if (_entry1.Key == key)
            ...
            case 6:
                if (_entry0.Key == key)
                {
                    ...
                    _entry5.Value = UnsetValue.Instance;
                    --_count;
                    break;
                }
                if (_entry1.Key == key)
    ...
    public override void RemoveEntry(int key)
    {
        for (int index = 0; index < _count; ++index)
        {
            if (_entries![index].Key == key)
            {
                ...
                _entries[_count - 1].Value = UnsetValue.Instance;
                --_count;
                break;
            }
        }
...
internal sealed class HashObjectMap : FrugalMapBase
{
    ...
    public override void Promote(FrugalMapBase newMap)
    {
        ...
        throw CreateCannotPromoteBeyondHashtableException();
    }
...
internal struct FrugalMap
{
    ...
    public object this[int key]
    {
        get
        {
            // If no entry, UnsetValue.Instance is returned
            if (null != _mapStore)
            {
        ...
        set
        {
            if (value != UnsetValue.Instance)
            {
                ...
                else
                {
                    ...
                    {
                        throw FrugalMapBase.CreateCannotPromoteBeyondHashtableException();
                    }
            ...
            {
                // UnsetValue.Instance means remove the value
                if (null != _mapStore)
                {
