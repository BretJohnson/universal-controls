...
{
    public abstract partial class UniversalControl : HostFrameworkUniversalControl, IUIElement, IVisualElement, IVisualElement2
    {
        private Size _desiredSize;
        private Vector3 _translation = Vector3.Zero;
        internal readonly MaterializableList<IUIElement> _children = new MaterializableList<IUIElement>();
        ...
        // Methods below are copied, with modifications, from UIElement.cs in the Uno project.

        public Size DesiredSize => IsVisible && HasLayoutStorage ? m_desiredSize : default;
